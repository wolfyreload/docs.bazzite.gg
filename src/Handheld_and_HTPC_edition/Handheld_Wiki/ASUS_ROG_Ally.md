...
- Some users report the mic sounding garbled
  ...
  - For Discord you also need to set the input profile in the Discord Settings to voice canceletion.
- (Xbox Ally Only) Audio swaps from left to right interal speakers as mono.
